...
run_func:
    ...
    # code
	leaq	-50(%rdi), %rdi	# compute i = menuOption-50
	cmpq	$10, %rdi	# compare menuOption:10
	ja	.L2	# if > go to deault case
	jmp	*.L1(,%rdi,8)	# go to JT[i]
...
.L53:
    ...
    popq    %rdx    # set dst pstring address as third argument
    ...
    movq    $format_c53, %rdi   # set print format as first argument
    popq    %rdx    # set src pstring address as third argument
    incq    %rdx    # go to the first byte of the string
    movq    $0, %rax
    call    printf
